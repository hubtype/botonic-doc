...
The `render()` is the function that describes what it will be returned as an output of the bot using RCML. All the variables defined in `botonicInit` are stored in `{this.props}`.
