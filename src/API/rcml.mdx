...
Buttons and quickreplies can have an url link, a payload attached, a href attribute, or an action to be triggered.
...
<messages>
    ...
    <message type="text">
        And now, I display three quickreplies, two with a payload and one triggering an action:
...
render() {
	return (
	    <messages>
	        ...
	        <message type="carousel">
			    <element key="1">
			        <pic>https://botonic.io/images/botonic_react_logo-p-500.png</pic>
			        <title>Title1</title>
			        <desc>Subtitle1</desc>
			        <button url="https://botonic.io">Visit botonic.io</button>
			    </element>
  ...
  render() {
    return(
      <messages>
        <message type="text">
          I am a share button!
          <Botonic.ShareButton payload={this.props.my_share_button}></Botonic.ShareButton>
        </message>
      </messages>           
    ) 
  }
...
If you want more degrees of freedom, you can also define your messages like this:
  ...
  render() {
    return(
      <messages>
        ...
        <Botonic.MessageTemplate payload={this.props.my_message_template}></Botonic.MessageTemplate>
        </message>
      </messages>           
    ) 
  }
