---
name: 4. Dynamic Carrousel Bot
route: /tutorials-and-examples/dynamic_carrousel-bot
menu: 4. Tutorials & Examples
order: -4
---

# Dynamic Carrousel Bot
...
The source code can be found in the following link: https://github.com/hubtype/botonic/tree/languages/templates/dynamic_carrousel
